...
class _BannerWidgetState extends State<BannerWidget>
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(Uri.parse(Apiconst.Level));
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            InkWell(
                                onTap: () {
                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>PlayWithFriends()));
                                },
  ...
  // Invite_Room({String level}  )async{
