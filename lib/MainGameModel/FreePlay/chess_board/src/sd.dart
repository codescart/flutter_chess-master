...
import 'package:chess_bot/generated/messages_all.dart';
...
class GeneratedLocalizationsDelegate extends LocalizationsDelegate<Sd> {
  ...
  @override
  Future<Sd> load(Locale locale) {
    return Sd.load(locale);
  }
