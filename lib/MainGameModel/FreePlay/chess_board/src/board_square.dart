...
import 'package:chess_bot/MainGameModel/FreePlay/chess_board/src/chess_sub.dart' as chess;
...
class _BoardSquareState extends State<BoardSquare>
  ...
  Widget build(BuildContext context) {
    ...
    int milliseconds = 0;
    if (((widget.squareName == ChessControllerd.moveFrom) ||
        (widget.squareName == ChessControllerd.moveTo))) {
      if (!ChessControllerd.loadingBotMoves) milliseconds = 600;
      background = Colors.green[700];
    }

    if (ChessControllerd.kingInCheck == widget.squareName)
    ...
    return showDialog<String>(
      ...
      builder: (BuildContext context) {
        return new AlertDialog(
          title: Text(stringsd.choose_promotion),
          content: Row(
